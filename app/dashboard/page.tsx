...
import { mockGroup, mockProposals } from "@/lib/mock-data"
...
export default function DashboardPage() {
  ...
  const { user, currentGroup, proposals, setCurrentGroup, setProposals } = useStore()
  ...
  }, [user, currentGroup, proposals, setCurrentGroup, setProposals, router])
